      ...
      <div className="pt-6">
        ...
        <section className="grid grid-cols-1 lg:grid-cols-2 gap-y-10 px-4 pt-10">
          ...
          <div className="flex flex-col items-center">
            <div className="overflow-hidden rounded-lg max-w-[30rem] ma-h-[35rem]">
              <img
            ...
            <div className="flex flex-wrap space-x-5 justity-center">
          ...
          {/* Product info */}
          <div className="lg:col-span-1 maxt-auto max-w-2x1 px-4 pd-16 sm:px-6 lg:-w-7x1 lg:px-8 lg:pb-24">
            <div className="lg:col-span-2 ">
              <h1 className="text-lg lg:text-lx font-semibold text-gray-900 ">
                {" "}
                Universaloutfit
              </h1>
              <h1 className="text-lg lg:text-xl text-gray-900 opacity-60 pt-1">
                casual Puff sleevasa Solid Women White Top
              </h1>
            </div>
       ...
       <section>
        ...
        <div className="border p-5">
          <Grid container spacing={7}>
            ...
            <Grid item xs={5}>
              <h1 className="text-x1 font-semibold pd-2">product Rating</h1>
       ...
       <section className="pt-10">
        ...
        <h1 className="py-5 text-xl font-bold">Similler Products</h1>
